...
const BaxsaaCaseStudy = () => (
  <CaseStudyLayout
    ...
    title="The Baxsaa"
    accentTitle="Co."
    subtitle="A Mumbai studio that makes premium custom packaging. We made the studio easier to find online and gave the brand a sharper look, helping more of the right buyers see the work and get in touch."
    mobileSubtitle="A Mumbai custom packaging studio. We made it easier to find online and gave the brand a sharper look."
