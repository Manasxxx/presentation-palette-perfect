...
- Slide 2's right-side technical illustration is intentionally pushed toward the right edge on desktop. Keep that edge-biased placement unless the user asks to recentre the image.
