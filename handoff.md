...
Session 30 (current) is a large pass: removed the Our Team slide entirely, cleared the Hallmark-audit backlog, moved all animation onto Anime.js (GSAP fully removed), ran a mobile polish round, and did a plain-language rewrite of the Services / Buyer Systems content.
