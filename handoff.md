...
Session 35 (current) reshaped the case-study block (added Kuraray, removed Raychem) and ran a focused desktop+mobile cover (TitleSlide) pass, plus a mobile shimmer exception on Clients.
